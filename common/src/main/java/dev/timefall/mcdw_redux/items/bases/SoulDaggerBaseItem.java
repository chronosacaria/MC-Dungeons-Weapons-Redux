...
public class SoulDaggerBaseItem extends SwordItem implements IInnateEnchantment {
    String[] repairIngredient;

    @SuppressWarnings("UnstableApiUsage")
    public SoulDaggerBaseItem(ToolMaterial material, int attackDamage, float attackSpeed, String[] repairIngredient) {
